...
\]
の形に整理せよ。ここで $\Gamma_m\,(\ge0)$ は各モードの一様な\textbf{減衰率}，すなわち $-\Gamma_m P_m$ の項の
係数であり，$x$ について積分した $\displaystyle\int P_m\,dx$ が $e^{-\Gamma_m t}$ に従って減衰する率を表す
（$D_x$ は $x$ 方向の実効拡散定数）。実効拡散定数 $D_x$ と減衰率 $\Gamma_m$ を，それぞれ $D,R,m$ で表せ。
