...
\subsection{Vector Potential、電磁場中の荷電粒子}
...
保存力の下での運動は既に定式化したので、
次は話を$3$次元に限り、
vector potentialで書かれる力を
解析力学の枠組みで扱うことにしよう。
なお、以下では専ら磁場を扱うが、
vector potentialで書かれるより一般の力についても
以下の議論は同様に成り立つ。
...
電磁場がない場合のLagrangian $L = T - V$を使って
\begin{align}
