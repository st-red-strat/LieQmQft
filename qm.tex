...
source項を持つ$1$次元調和振動子のLagrangian
\begin{align}
    L_{cl}
    &:=
    \frac{1}{2}m\dot{q}^2
...
\end{align}
として実現できるだろう。
ここで$Jac$は$x(t)$から$a_n$への変数変換による
Jacobianである。
さて、公式
...
最後に$Jac$を求める。
明らかに$Jac$は$J(t)$にも$\omega$にもよらないので、
$J(t) = 0, \omega = 0$の場合の$Jac$を求めればよい。
$\dot{q}_{cl}$
