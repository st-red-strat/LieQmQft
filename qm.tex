...
このように互いに可換なoperatorのうち一方の固有vectorは
同時に他方の固有vectorにも取ることができ、
そのようなvectorを同時（simultaneous）固有vecctorという。
独立なHermitian operatorのうち可換に取れるものの
maximalな個数が$n$であるとき、そのような
一般に、
